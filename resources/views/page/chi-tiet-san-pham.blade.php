                            ...
                            <div class="single-item-body">
                                ...
                                <p class="single-item-price">
                                    @if($product_detail->promotion_price == 0)
                                        <span class="flash-sale">{{number_format($product_detail->unit_price,0,",",".")}} đ</span>
                                    @else
                                        <span class="flash-del">{{number_format($product_detail->unit_price,0,",",".")}} đ</span>
                                        <span class="flash-sale">{{number_format($product_detail->promotion_price,0,",",".")}} đ</span>
                                    @endif
                                </p>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="product.html"><img src="source/images/products/4.jpg" alt=""></a>
                                    </div>
                                    <div class="single-item-body">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            <div class="beta-sales beta-lists">
                                ...
                                <div class="media beta-sales-item">
                                    <a class="pull-left" href="product.html"><img src="source/image/products/3.png" alt=""></a>
                                    <div class="media-body">
                                        Sample Woman Top
                                        <span class="beta-sales-price">$34.55</span>
                                    </div>
                                ...
                                <div class="media beta-sales-item">
                                    <a class="pull-left" href="product.html"><img src="source/image/products/4.png" alt=""></a>
                                    <div class="media-body">
                                        Sample Woman Top
                                        <span class="beta-sales-price">$34.55</span>
                                    </div>
